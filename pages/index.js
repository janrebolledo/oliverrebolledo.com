    ...
    <section className="w-full">
      ...
      <div className="px-10% grid grid-cols-12 mb-12" id="about">
        ...
        <p className="col-span-12 md:col-span-9">
          ...
          VIDEOGRAPHER WITH OVER 8 YEARS OF EXPERIENCE. I'VE WORKED ON A VARIETY
          OF PROJECTS AND HAVE WORKED WITH VARIOUS ARTISTS OVER THE YEARS. THESE
          INCLUDE LOS GEMELOS DE SINALOA, LDNE, ANGEL TUMBADO, DAVID SANTOS, AND
          ZEXTA ALIANZA AMONGST OTHERS. I AM PROFICIENT IN VIDEOGRAPHY,
          PHOTOGRAPHY, EDITING AND MIXING. I HAVE A LARGE COLLECTION OF
          EQUIPMENT TO MEET THE NEEDS OF ALL MY CLIENTS.
          <br />
          <br />
